...
- Using ggplot2 to make graphs showing patterns across different countries, dates, tags, likes/dislikes, etc.
- Using regular expressions to look for certain keywords in the descriptions, tags, and titles of the videos.
- Taking the ratios of likes to dislikes and see if there are any patterns with that. Maybe see if the relationship between likes and comments or dislikes and comments is stronger.
