...
> For trending videos do they have any patterns in tags across countries?
...
in_fr_join = common_tags(fr_data, "-fr", in_data, "-in")
in_fr_join
ca_us_join = common_tags(ca_data, "-ca", us_data, "-us" )
ca_us_join
gb_mx_join = common_tags(gb_data, "-gb", mx_data, "-mx")
gb_mx_join
```
